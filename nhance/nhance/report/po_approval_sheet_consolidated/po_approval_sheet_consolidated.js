...
/* eslint-disable */
frappe.query_reports["Po Approval Sheet Consolidated"] = {
    "filters": [{
            "fieldname": "date",
            "label": __("Date"),
            "fieldtype": "Date",
...
function ready_for_approval_po_number(po_number) {
    frappe.call({
        method: 'shark.shark.report.po_approval_sheet_consolidated.po_approval_sheet_consolidated.ready_for_approval_po',
        args: {
            "po_number": po_number,
        },
        async: false,
...
function approve_po_number(po_number) {
    console.log("---------------")
    frappe.call({
        method: 'shark.shark.report.po_approval_sheet_consolidated.po_approval_sheet_consolidated.approve_po',
        args: {
            "po_number": po_number,
        },
        async: false,
...
function reject_po_number(po_number) {
    frappe.call({
        method: 'shark.shark.report.po_approval_sheet_consolidated.po_approval_sheet_consolidated.reject_po',
        args: {
            "po_number": po_number,
        },
        async: false,
...
function rework_po_number(po_number) {
    frappe.call({
        method: 'shark.shark.report.po_approval_sheet_consolidated.po_approval_sheet_consolidated.rework_po',
        args: {
            "po_number": po_number,
        },
        async: false,
...
function cancel_po_number(po_number) {
    frappe.call({
        method: 'shark.shark.report.po_approval_sheet_consolidated.po_approval_sheet_consolidated.cancel_po',
        args: {
            "po_number": po_number,
        },
        async: false,
