...
def execute(filters=None):
	...
	for (company, bom, item) in sorted(iwb_map):
                qty_dict = iwb_map[(company, bom, item)]
                data.append([
...
def get_item_warehouse_map(filters):
		...
		qty_dict.bal_qty = get_stock(d.item_code, d.company)
		
                qty_dict.bal_val = get_stock_val(d.item_code, d.company)
...
def get_stock_val(item_code, company):
