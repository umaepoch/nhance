...
def execute(filters=None):
	...
	for serial_data in serial_no_details:
		...
		coc=serial_data['coc'],
		pressure_test=serial_data['pressure_test'],
		build_sheet=serial_data['build_sheet'],
		combined_pdf=serial_data['combined_pdf']
		...
		data.append([serial_data['item_code'],serial_data['item_name'],serial_data['serial_no'],serial_data['coc'], serial_data['pressure_test'],serial_data['build_sheet'],serial_data['combined_pdf'],serial_data[''],serial_data[''],serial_data['po_no'],serial_data['po_date'],serial_data['delivery_document_no'],serial_data['delivery_date']
					])
...
def fetching_serial_no_details(filters):
	...
	if filters.get("customer_po"):
		...
		serial_details = frappe.db.sql("""select sn.coc,sn.pressure_test,sn.build_sheet,sn.combined_pdf,"","",dn.po_no,dn.po_date,sn.delivery_document_no,sn.delivery_date,sn.item_code,sn.item_name,sn.serial_no
			from 
