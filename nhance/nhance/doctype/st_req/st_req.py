...
class StReq(BuyingController):
	...
	# ---------------------
	def validate(self):
		print("***************From mr Enters validate")
		super(MaterialRequest, self).validate()
		print("***************From mr passed super ()")
...
def get_material_requests_based_on_supplier(supplier):
	...
	material_requests = frappe.db.sql_list("""select distinct mr.name
		from `tabMaterial Request` mr, `tabSt Req Items` mr_item
